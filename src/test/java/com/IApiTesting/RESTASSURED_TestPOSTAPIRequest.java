...
public class RESTASSURED_TestPOSTAPIRequest {
	...
	public void TestPOSTAPIRequest() {
		...
		builder.setContentType(
				"application/json; charset=UTF-8;Authorization =INTUIT_IAM x_intuit_authid= INTUIT_IAM x_intuit_authid= 123146438639669,x_intuit_ticket= V1-61-a3donyird52w7z2tiypb6k;intuit-realmid=123146431166944");
